...
class AdiEmsWebApiV2DtoWeatherWeatherPhenomenon(Model):
    ...
    :type intensity: str or ~swagger.models.enum
    ...
    :type qualifier: str or ~swagger.models.enum
    ...
    :type precipitation: str or ~swagger.models.enum
    ...
    :param other: Other weather cases that do not fall under precipitation.
     ...
     'sandstorm', 'duststorm'
    :type other: str or ~swagger.models.enum
    """

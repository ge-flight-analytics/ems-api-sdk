...
class WeatherOperations(object):
    ...
    def parse_taf(
        ...
        :param options: An object with the TAF string to parse along with
         ...
         parsing.
        :type options:
         ~swagger.models.AdiEmsWebApiV2DtoWeatherTafTafParseOptions
    ...
    def parse_metar(
        ...
        :type options:
         ~swagger.models.AdiEmsWebApiV2DtoWeatherMetarMetarParseOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def query_tafs(
        ...
        :type options: ~swagger.models.AdiEmsWebApiV2DtoWeatherTafTafQuery
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def query_metars(
        ...
        :type options: ~swagger.models.AdiEmsWebApiV2DtoWeatherMetarMetarQuery
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration

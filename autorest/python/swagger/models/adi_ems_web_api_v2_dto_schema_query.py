...
class AdiEmsWebApiV2DtoSchemaQuery(Model):
    ...
    :type select: list[~swagger.models.AdiEmsWebApiV2DtoSchemaSelectColumn]
    :param group_by: An array specifying the fields by which to group
     aggregate operations. If not specified, no grouping
     is performed
    :type group_by: list[~swagger.models.AdiEmsWebApiV2DtoSchemaGroupByColumn]
    ...
    :type order_by: list[~swagger.models.AdiEmsWebApiV2DtoSchemaOrderByColumn]
    ...
    :param format: Value formatting that should be performed on results values
     ...
     'display'
    :type format: str or ~swagger.models.enum

...
class AdiEmsWebApiV2ModelAnalyticQuery(Model):
    ...
    :type select:
     list[~swagger.models.AdiEmsWebApiV2ModelAnalyticAnalyticSelect]
    ...
    :type unsampled_data_mode: str or ~swagger.models.enum
    ...
    :type offset_type: ~swagger.models.AdiEmsWebApiV2ModelAnalyticOffsetType
